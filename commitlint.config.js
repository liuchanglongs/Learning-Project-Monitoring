...
module.exports = {
  // 继承官方的 @commitlint/config-conventional 配置，这是业内广泛使用的标准规范
  extends: ['@commitlint/config-conventional'], // extends can be nested
  //   使用 conventional-changelog-conventionalcommits 作为解析器
  parserPreset: 'conventional-changelog-conventionalcommits',
  //   定义验证规则，这里 scope-enum 规则要求 commit 的 scope 必须从上述 scopes 数组中选择
  rules: {
